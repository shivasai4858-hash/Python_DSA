...
my_double_linked_list = DoublyLinkedLists(1)
my_double_linked_list.append(2)
my_double_linked_list.append(3)
my_double_linked_list.append(10)
my_double_linked_list.prepend(6)
my_double_linked_list.pop()
my_double_linked_list.pop_first()
my_double_linked_list.set_value(2,3)
my_double_linked_list.insert(1,2)
my_double_linked_list.remove(2)
my_double_linked_list.get(2)
